...
app.post('/api/employees', async (req, res) => {
  try {
    ...
    `, [
      ...
      req.body.pagibig_number || req.body.pagibigNumber || '',
      req.body.sss_number || req.body.sssNumber || '',
      req.body.philhealth_number || req.body.philhealthNumber || '',
      req.body.address || '',
      parseFloat(req.body.cash_advance || req.body.cashAdvance) || 0,
      parseFloat(req.body.loans) || 0,
      req.body.auto_deduct_cash_advance !== false && req.body.autoDeductCashAdvance !== false, // Default true
      req.body.auto_deduct_loans !== false && req.body.autoDeductLoans !== false // Default true
    ]);
...
app.put('/api/employees/:uuid', async (req, res) => {
  try {
    ...
    `, [
      ...
      parseFloat(req.body.cash_advance || req.body.cashAdvance) || 0,
      parseFloat(req.body.loans) || 0,
      req.body.auto_deduct_cash_advance !== false && req.body.autoDeductCashAdvance !== false,
      req.body.auto_deduct_loans !== false && req.body.autoDeductLoans !== false,
      req.params.uuid
    ]);
